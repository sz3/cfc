...
namespace {
	...
	void drawDebugInfo(cv::Mat& mat)
	{
		...
		sstop << (MultiThreadedDecoder::bytes / std::max<double>(1, MultiThreadedDecoder::decoded)) << "b v0.5cl";
		...
		ssperf << ", to-gpu: " << millis(MultiThreadedDecoder::gpuToTicks, MultiThreadedDecoder::gpup);
